...
if ($buscar !== '') {
    $deportistas = array_values(array_filter($deportistas, static fn (array $deportista): bool => stripos((string) $deportista['nombre'], $buscar) !== false));
}
